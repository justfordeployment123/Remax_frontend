            ...
            <div className="mb-6">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-4 py-3 text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
                />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-12">
            <div>
              ...
              <p className="text-gray-600">Discover your dream home from our premium selection</p>
            </div>
            <div className="flex flex-col sm:flex-row sm:items-center gap-3 w-full md:w-auto">
              <select className="w-full sm:w-auto px-4 py-3 text-sm text-gray-700 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white">
              ...
              <div className="inline-flex border border-gray-300 rounded-md overflow-hidden w-full sm:w-auto">
                <button className="px-4 py-3 text-sm font-medium bg-[#1A3668] text-white hover:bg-[#1A3668]/80 transition-colors">
                  List View
                </button>
              ...
              <div key={property} className="group bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg cursor-pointer border border-gray-100">
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 text-sm font-semibold">
                    {property % 2 === 0 ? "Luxury" : "New"}
                  </div>
                  <div className="absolute bottom-4 left-4 bg-[#1A3668] text-white rounded-sm px-1 py-1 text-sm font-semibold">
                    For Sale
                  </div>
                </div>
                <div className="p-6">
          ...
          <div className="text-center mt-16">
            <button className="bg-[#1A3668] text-white px-8 py-3 font-medium rounded-md hover:bg-[#1A3668]/80 focus:outline-none focus:ring-2 focus:ring-[#1A3668]/50 focus:ring-offset-2 transition-all duration-200">
              Load More Properties
            </button>
            <p className="text-gray-600 mt-4 text-sm">Showing 6 of 1,247 properties</p>
          </div>
        </div>
      </section>
      <Footer />
