    ...
    <main className="min-h-screen bg-white">
            ...
            <div>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-3">
                  <Check className="w-4 sm:w-5 h-4 sm:h-5 text-[#00458b] flex-shrink-0 mt-1" />
                  <span className="text-xs sm:text-sm lg:text-base text-gray-700">Integrated view: lease + design + build.</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-4 sm:w-5 h-4 sm:h-5 text-[#00458b] flex-shrink-0 mt-1" />
                  <span className="text-xs sm:text-sm lg:text-base text-gray-700">Partners experienced with Dubai approvals and regulations.</span>
                </li>
                <li className="flex items-start gap-3">
                  <Check className="w-4 sm:w-5 h-4 sm:h-5 text-[#00458b] flex-shrink-0 mt-1" />
                  <span className="text-xs sm:text-sm lg:text-base text-gray-700">Focus on function, budget and timeline – not just pretty renders.</span>
                </li>
              </ul>
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-12 text-center max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 mb-12">
            ...
            <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg sm:rounded-xl border-2 border-[#00458b]/20 shadow-sm">
              <h3 className="text-xl sm:text-2xl lg:text-2xl font-bold text-gray-900 mb-6">
              ...
              <ul className="space-y-4">
                {roleLeft.map((role, index) => (
                  <div key={index} className="flex gap-3">
                    ...
                    <div>
                      <h4 className="text-sm sm:text-base lg:text-base font-semibold text-gray-900">{role.title}</h4>
                      <p className="text-xs sm:text-sm lg:text-sm text-gray-600 mt-1">{role.description}</p>
                    </div>
                  </div>
                ))}
              </ul>
            ...
            <div className="bg-white p-4 sm:p-6 lg:p-8 rounded-lg sm:rounded-xl border-2 border-green-200 shadow-sm">
              <h3 className="text-xl sm:text-2xl lg:text-2xl font-bold text-gray-900 mb-6">
          ...
          <div className="bg-blue-50 p-4 sm:p-5 lg:p-6 rounded-lg sm:rounded-xl border-l-4 border-[#00458b] text-center">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {examples.map((example, index) => (
              <div key={index} className="rounded-lg sm:rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                <div className="bg-gray-100 p-4 sm:p-5 lg:p-6 border-b border-gray-200">
                  <h3 className="text-base sm:text-lg lg:text-lg font-bold text-gray-900">
                    {example.title}
                  </h3>
                  <p className="text-xs sm:text-sm lg:text-sm text-gray-600 mt-3">
                    {example.description}
                  </p>
                </div>
                <div className="relative h-[200px] sm:h-[250px] lg:h-[300px] bg-gray-200">
                  <Image
      ...
      <section className="py-8 sm:py-12 lg:py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="relative h-[200px] sm:h-[280px] lg:h-[350px] rounded-lg sm:rounded-2xl overflow-hidden mb-8 sm:mb-10 lg:mb-12">
            <Image
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 lg:gap-6 mb-12">
            {processSteps.map((step, index) => {
              ...
              return (
                <div key={index} className="bg-white p-4 sm:p-5 lg:p-6 rounded-lg sm:rounded-xl border-2 border-[#00458b]/20 shadow-sm">
                  ...
                  <h3 className="text-base sm:text-lg lg:text-lg font-bold text-gray-900 mb-3">
                    {step.title}
                  </h3>
      ...
      {/* Form Section */}
      <section id="fitout-form" className="py-8 sm:py-12 lg:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          {submitted ? (
            <div className="max-w-2xl mx-auto bg-green-50 p-6 sm:p-8 lg:p-12 rounded-lg sm:rounded-xl border-2 border-green-200 text-center">
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4">
                Thank You – Enquiry Received
              </h3>
              <p className="text-sm sm:text-base lg:text-lg text-gray-700 mb-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
              {/* Left Column - Copy */}
              <div>
                <p className="text-base sm:text-lg lg:text-lg text-gray-700 mb-6 leading-relaxed">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start gap-3">
                    <Check className="w-4 sm:w-5 h-4 sm:h-5 text-[#00458b] flex-shrink-0 mt-1" />
                    <span className="text-xs sm:text-sm lg:text-base text-gray-700">Early advice on layout and budget before you lock in a unit.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-4 sm:w-5 h-4 sm:h-5 text-[#00458b] flex-shrink-0 mt-1" />
                    <span className="text-xs sm:text-sm lg:text-base text-gray-700">Honest view on what's realistic in your budget and timeframe.</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <Check className="w-4 sm:w-5 h-4 sm:h-5 text-[#00458b] flex-shrink-0 mt-1" />
                    <span className="text-xs sm:text-sm lg:text-base text-gray-700">Introduction to TrueBuild and other fit-out partners when the scope is clear.</span>
                  </li>
                </ul>
              </div>

              {/* Right Column - Form */}
              <div className="bg-gray-50 p-5 sm:p-6 lg:p-8 rounded-lg sm:rounded-xl border border-gray-200">
                <h3 className="text-xl sm:text-2xl lg:text-2xl font-bold text-gray-900 mb-6">
                  Share Your Fit-Out Requirements
                </h3>

                {error && (
                  <div className="mb-6 p-3 sm:p-4 bg-red-50 border border-red-200 rounded-lg text-xs sm:text-sm text-red-700">
                    {error}
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  {/* Full Name */}
                  <div>
                    <label className="block text-xs sm:text-sm lg:text-sm font-semibold text-gray-900 mb-2">
                      Full Name *
                    </label>
                    <input
                      type="text"
                  ...
                  {/* Lease Status */}
                  <div>
                    <label className="block text-xs sm:text-sm lg:text-sm font-semibold text-gray-900 mb-3">
                    ...
                    <div className="space-y-2">
                      <label className="flex items-center">
                        <input
                          ...
                          required
                        />
                        <span className="ml-2 text-xs sm:text-sm lg:text-sm text-gray-700">Yes, we have a lease signed</span>
                      </label>
                      <label className="flex items-center">
                        <input
                          type="radio"
                          ...
                          className="w-4 h-4 accent-[#00458b]"
                        />
                        <span className="ml-2 text-xs sm:text-sm lg:text-sm text-gray-700">Shortlisted but not signed</span>
                      </label>
                      <label className="flex items-center">
                        <input
                          type="radio"
                          ...
                          className="w-4 h-4 accent-[#00458b]"
                        />
                        <span className="ml-2 text-xs sm:text-sm lg:text-sm text-gray-700">Still looking</span>
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3 pt-2">
                    <input
                      ...
                      required
                    />
                    <label className="text-xs sm:text-sm lg:text-sm text-gray-700">
      ...
      {/* Final CTA */}
      <section className="py-8 sm:py-12 lg:py-20 bg-gradient-to-br from-[#00458b] to-[#003366] relative overflow-hidden">
        {/* Background Image */}
