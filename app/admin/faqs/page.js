  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.message || "Error deleting FAQ");
      }
    } catch (error) {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-green-600 text-white rounded-sm font-semibold hover:bg-green-700 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-6 py-3 bg-[#1A3668] text-white rounded-sm font-semibold hover:bg-[#152d54] transition-colors"
            >
        ...
        {/* Bulk Import Section */}
        {showBulkImport && (
          <div className="mb-8 bg-white rounded-sm shadow-lg p-8 border-l-4 border-green-600">
            ...
            {/* Import Instructions */}
            <div className="mb-8 bg-blue-50 border border-blue-200 rounded-sm p-6">
            ...
            <details className="mb-8 bg-gray-50 border border-gray-300 rounded-sm p-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <button
                  ...
                  disabled={bulkImporting}
                  className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-sm font-semibold hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
            ...
            {/* Info Box */}
            <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-sm p-4">
        ...
        <div className="mb-6">
          ...
          <select
            ...
            className="w-full md:w-64 px-4 py-2 border border-gray-300 rounded-sm focus:ring-2 focus:ring-[#1A3668] outline-none"
          >
                ...
                <div className="flex justify-between items-start gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="p-2 text-gray-600 hover:text-[#1A3668] hover:bg-blue-50 rounded-sm transition-colors"
                      title="Edit"
                    >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    maxLength="500"
                    className={`w-full px-4 py-2 border rounded-sm focus:ring-2 focus:ring-[#1A3668] outline-none transition-colors ${
                      formData.question.length > 500 
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows="8"
                    maxLength="2000"
                    className={`w-full px-4 py-2 border rounded-sm focus:ring-2 focus:ring-[#1A3668] outline-none resize-none transition-colors ${
                      formData.answer.length > 2000 
                        ? 'border-red-500 bg-red-50' 
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      required
                      className="w-full px-4 py-2 border border-gray-300 rounded-sm focus:ring-2 focus:ring-[#1A3668] outline-none"
                    >
                      {categoryOptions.map((cat) => (
                        <option key={cat.value} value={cat.value}>
                          {cat.label}
                ...
                <div className="flex gap-3 justify-end border-t border-gray-200 pt-6">
                  <button
                    type="button"
                    onClick={handleCloseModal}
                    className="px-6 py-2 border border-gray-300 text-gray-700 rounded-sm font-semibold hover:bg-gray-50 transition-colors"
                  >
                    Cancel
                  </button>
                  <button
                    ...
                    className={`px-6 py-2 text-white rounded-sm font-semibold transition-colors ${
