...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative w-full overflow-hidden min-h-[400px] sm:min-h-[500px] lg:min-h-[550px]" style={{ height: 'auto' }}>
        <div
          className="absolute inset-0 bg-cover bg-center bg-no-repeat"
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1682410601760-6372fd33ad2b?q=80&w=1200&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')`,
        ...
        <div className="relative z-10 min-h-[400px] sm:min-h-[500px] lg:min-h-[550px] flex flex-col justify-center items-start px-4 sm:px-6 lg:px-16 py-12 sm:py-16 lg:py-20">
          <div className="max-w-2xl pt-8 sm:pt-0">
            <h1 className="text-white font-bold mb-3 sm:mb-4 leading-tight text-2xl sm:text-3xl lg:text-5xl" 
                style={{ 
                  lineHeight: '1.2'
                }}>
            ...
            <p className="text-white text-sm sm:text-base lg:text-lg mb-6 sm:mb-8 leading-relaxed max-w-xl opacity-90">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 mb-6 sm:mb-10">
              <button
                ...
                className="bg-[#00458b] text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-md text-xs sm:text-sm font-semibold hover:bg-[#003366] transition-colors duration-200 w-full sm:w-fit"
              >
                Share Your Requirements
              </button>
              <button
                onClick={() => openConsultation()}
                className="border-2 border-white text-white px-4 sm:px-6 py-2.5 sm:py-3 rounded-md text-xs sm:text-sm font-semibold hover:bg-white hover:text-gray-900 transition-colors duration-200 w-full sm:w-fit"
              >
                Book a Consultation
              </button>
            </div>

            <div className="grid grid-cols-3 gap-2 sm:gap-6 pt-4 sm:pt-6 border-t border-white/30">
              <div className="text-white">
                <h4 className="font-semibold text-xs sm:text-sm mb-0.5 sm:mb-1">Dubai Experts</h4>
                <p className="text-xs opacity-75">Freehold specialists</p>
              </div>
              <div className="text-white">
                <h4 className="font-semibold text-xs sm:text-sm mb-0.5 sm:mb-1">Global RE/MAX</h4>
                <p className="text-xs opacity-75">Worldwide network</p>
              </div>
              <div className="text-white">
                <h4 className="font-semibold text-xs sm:text-sm mb-0.5 sm:mb-1">Advisor Mindset</h4>
      ...
      <section className="py-8 sm:py-12 lg:py-24 bg-white border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4">
          <div className="min-h-auto lg:h-[280px] rounded-lg sm:rounded-2xl p-4 sm:p-6 lg:p-16 flex flex-col lg:flex-row items-center gap-4 sm:gap-6 lg:gap-12 border border-gray-200 shadow-md bg-gray-50">
            ...
            <div className="flex-1 flex flex-col justify-center text-center lg:text-left">
              <h3 className="font-extrabold text-gray-900 mb-2 sm:mb-3 lg:mb-4 text-base sm:text-lg lg:text-2xl leading-tight">
                Most Trusted Real Estate Agents in North America – Now in the U.A.E.
              </h3>
              <p className="text-gray-700 leading-relaxed text-xs sm:text-sm lg:text-lg max-w-2xl mx-auto lg:mx-0">
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-10 items-center">
            ...
            <div>
              ...
              <p className="text-xs sm:text-base lg:text-lg text-gray-600 mb-3 sm:mb-4 font-semibold">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-0 mb-4 sm:mb-6 bg-white rounded border border-gray-200 overflow-hidden divide-y sm:divide-y-0 sm:divide-x divide-gray-200">
                <div className="text-center py-2 sm:py-3 px-2 sm:px-3">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                <Link href="/playbook-2026-2035">
                  <button
                    className="w-full sm:w-auto bg-[#00458b] text-white px-4 sm:px-5 py-2.5 sm:py-2 rounded-md text-xs sm:text-sm font-semibold hover:bg-[#003366] transition-colors duration-200"
                  >
                    Download Playbook
                  </button>
                </Link>
                <button
                  ...
                  className="w-full sm:w-auto border-2 border-[#00458b] text-[#00458b] px-4 sm:px-5 py-2.5 sm:py-2 rounded-md text-xs sm:text-sm font-semibold hover:bg-[#00458b] hover:text-white transition-colors duration-200"
                >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-5">
            ...
            >
              <div className="relative h-40 sm:h-44 overflow-hidden bg-gray-200">
                <img
                  src="https://images.unsplash.com/photo-1514940403093-cccd37db1528?q=80&w=500&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Buy a Home"
              ...
              <div className="p-3 sm:p-4 flex flex-col justify-between flex-1">
                <div>
                  <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 sm:mb-2">Buy a Home</h3>
                  <p className="text-gray-600 text-xs mb-2 sm:mb-3">Find the right villa or apartment with professional guidance in every negotiation.</p>
                </div>
            ...
            >
              <div className="relative h-40 sm:h-44 overflow-hidden bg-gray-200">
                <img
                  src="https://images.unsplash.com/photo-1640808476588-e96ae8e7a419?q=80&w=500&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Invest in Dubai"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                  loading="lazy"
                />
              ...
              <div className="p-3 sm:p-4 flex flex-col justify-between flex-1">
                <div>
                  <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 sm:mb-2">Invest in Dubai</h3>
                  <p className="text-gray-600 text-xs mb-2 sm:mb-3">Get curated opportunities based on your budget and risk profile.</p>
                </div>
                <button className="text-[#00458b] font-semibold text-xs flex items-center gap-1 group-hover:gap-2 transition-all">
                  View Opportunities
                  <ArrowRight className="w-3 h-3" />
            ...
            >
              <div className="relative h-40 sm:h-44 overflow-hidden bg-gray-200">
                <img
                  src="https://images.unsplash.com/flagged/photo-1559717201-fbb671ff56b7?q=80&w=500&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  alt="Lease & Manage"
                  className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300"
                  loading="lazy"
                />
              ...
              <div className="p-3 sm:p-4 flex flex-col justify-between flex-1">
                <div>
                  <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 sm:mb-2">Lease & Manage</h3>
                  <p className="text-gray-600 text-xs mb-2 sm:mb-3">Maximise rental income with professional leasing and tenant management.</p>
                </div>
                <button className="text-[#00458b] font-semibold text-xs flex items-center gap-1 group-hover:gap-2 transition-all">
                  Talk to Expert
                  <ArrowRight className="w-3 h-3" />
            ...
            >
              <div className="relative h-40 sm:h-44 overflow-hidden bg-gray-200">
                <img
                  src="https://images.unsplash.com/photo-1640877268187-2fa6b2ed7a5f?q=80&w=500&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
              ...
              <div className="p-3 sm:p-4 flex flex-col justify-between flex-1">
                <div>
                  <h3 className="text-sm sm:text-base font-bold text-gray-900 mb-1 sm:mb-2">Sell With a Strategy</h3>
                  <p className="text-gray-600 text-xs mb-2 sm:mb-3">Data-backed pricing and professional marketing to secure serious buyers.</p>
                </div>
                <button className="text-[#00458b] font-semibold text-xs flex items-center gap-1 group-hover:gap-2 transition-all">
                  Get Strategy
                  <ArrowRight className="w-3 h-3" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5">
            ...
            <Link href="/properties" className="group">
              <div className="rounded-lg overflow-hidden border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-300 h-full cursor-pointer bg-white">
                <div className="relative h-40 sm:h-44 overflow-hidden bg-gray-200">
                  <img
                    src="https://images.unsplash.com/photo-1737898378296-94dc316cd443?q=80&w=500&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                ...
                <div className="p-3 sm:p-5">
                  <h3 className="text-sm sm:text-lg font-bold text-gray-900 mb-1 sm:mb-2">Residential Homes</h3>
                  <p className="text-gray-600 text-xs mb-3 sm:mb-4">Apartments and villas for end-users and long-term investors.</p>
            ...
            <Link href="/off-plan" className="group">
              <div className="rounded-lg overflow-hidden border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-300 h-full cursor-pointer bg-white">
                <div className="relative h-40 sm:h-44 overflow-hidden bg-gray-200">
                  <img
                    src="https://images.unsplash.com/photo-1737475988869-59aaa06ebb83?q=80&w=500&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                ...
                <div className="p-3 sm:p-5">
                  <h3 className="text-sm sm:text-lg font-bold text-gray-900 mb-1 sm:mb-2">Off-Plan & New Projects</h3>
                  <p className="text-gray-600 text-xs mb-3 sm:mb-4">Access to new launches, allocations and early-stage opportunities.</p>
                  <button className="text-[#00458b] font-semibold inline-flex items-center gap-1 text-xs group-hover:gap-2 transition-all">
            ...
            <Link href="/commercial-real-estate-dubai" className="group">
              <div className="rounded-lg overflow-hidden border border-gray-200 hover:border-gray-300 hover:shadow-lg transition-all duration-300 h-full cursor-pointer bg-white">
                <div className="relative h-40 sm:h-44 overflow-hidden bg-gray-200">
                  <img
                    src="https://images.unsplash.com/photo-1706074740295-d7a79c079562?q=80&w=500&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                ...
                <div className="p-3 sm:p-5">
                  <h3 className="text-sm sm:text-lg font-bold text-gray-900 mb-1 sm:mb-2">Commercial & Offices</h3>
                  <p className="text-gray-600 text-xs mb-3 sm:mb-4">Office, retail and industrial spaces for businesses and investors.</p>
                  <button className="text-[#00458b] font-semibold inline-flex items-center gap-1 text-xs group-hover:gap-2 transition-all">
                    See Solutions
                    <ArrowRight className="w-3 h-3" />
                  </button>
      ...
      <section id="partners" className="py-8 sm:py-12 lg:py-16 bg-white border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-4">
            ...
            {partnerGroups.map((group) => (
              <div key={group.id}>
                <div className="mb-4 sm:mb-6">
                  <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-0.5 sm:mb-1">{group.label}</h3>
                ...
                {group.featured ? (
                  ...
                  <div className={`grid gap-2 sm:gap-4 ${
                    group.columns === 4 ? 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4' : 'grid-cols-2 md:grid-cols-3'
                  }`}>
                    {group.partners.map((partner) => (
                      <a
                        key={partner.name}
                        ...
                        className="flex flex-col items-center justify-center p-2 sm:p-4 rounded-lg border border-gray-100 hover:bg-gray-50 hover:border-gray-200 transition-all duration-200"
                        title={partner.tooltip}
                        aria-label={partner.tooltip}
                      >
                        <div className="flex items-center justify-center h-10 sm:h-12 mb-1 sm:mb-2 w-full">
                          <img
                            src={partner.logo}
                            alt={partner.name}
                            className="max-h-8 sm:max-h-10 object-contain max-w-full"
                            loading="lazy"
                          />
                        </div>
