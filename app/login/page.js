            ...
            <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Your email <span className="font-semibold">{unverifiedEmail}</span> hasn't been verified yet.
                </p>
                ...
                <button
                  ...
                  className="w-full bg-[#1A3668] text-white py-3 rounded-md font-semibold hover:bg-[#15294d] transition-all mb-3"
                >
                  Back to Login
                </button>
        ...
        <div className="max-w-lg mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-100">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Sign in to access your account and continue your property search</p>
            </div>
            ...
            <div className="flex items-center justify-between mb-6 mt-4">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input
                  ...
                  className="w-4 h-4 text-[#1A3668] rounded border-gray-300 focus:ring-[#1A3668] cursor-pointer group-hover:border-gray-400 transition-colors"
                />
                <span className="text-sm text-gray-700 group-hover:text-gray-900 transition-colors cursor-pointer">Remember me</span>
              </label>
              <a href="#" className="text-sm text-[#1A3668] hover:text-[#15294d] font-medium transition-colors hover:underline">
                Forgot password?
              </a>
            </div>
